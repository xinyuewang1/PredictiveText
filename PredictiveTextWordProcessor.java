...
//            System.out.println("Words from Predictve "+words);
            wordNumber = 0;
...
//            for (int i=0; i<count-1; i++) {
            ...
            while (count > 0 && count < words.size() ) {
//            	System.out.println(words);
//            	System.out.println("Before next "+pos.element());
                pos = words.next(pos);
//                System.out.println("After next "+pos.element());
