...
public class LinkedTree<T> implements Tree<T> {
	...
	public static void main(String[] args) {
		...
		//        System.out.println(tree.children(tree.root()));
		ListIterator<Position<Integer>> p = (ListIterator<Position<Integer>>) tree.children(tree.root());

		//       List<Position<Integer>> list = p.getList();
		System.out.println();
		//        for (Iterator<Position<Integer>> iter = ; iter.hasNext(); ) {
		//        	System.out.println(iter);
		//        	iter = (Iterator<Position<Integer>>) iter.next();
		//        }

		System.out.println();
		//        p = tree.children(p.element());
		//        System.out.println(tree.children(tree.root()).next());
		//        System.out.println(tree.children(tree.root()).next());

		while (p.hasNext()) {
			//			System.out.println("In while");
			System.out.println(p.next());
			//			p = (Position) tree.children(p).next();
		}
	}
}
